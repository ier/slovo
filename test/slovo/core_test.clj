...
(deftest ru-number-in-words-test
  ...
  (testing "1000 and more"
    (let [inputs-to-expected {1000 "Одна тысяча"
                              ...
                              12345678 "Двенадцать миллионов триста сорок пять тысяч шестьсот семьдесят восемь"
                              ...
                              12345678901 "Двенадцать миллиардов триста сорок пять миллионов шестьсот семьдесят восемь тысяч девятьсот один"
                              123456789987 "Сто двадцать три миллиарда четыреста пятьдесят шесть миллионов семьсот восемьдесят девять тысяч девятьсот восемьдесят семь"
                              987654321010 "Девятьсот восемьдесят семь миллиардов шестьсот пятьдесят четыре миллиона триста двадцать одна тысяча десять"
