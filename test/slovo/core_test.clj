...
(deftest ru-money-in-words-test
  ...
  (testing "kopecks"
    (let [inputs-to-expected {1.00 "Один рубль ноль копеек"
                              ...
                              7.1 "Семь рублей одна копейка"
                              7.2 "Семь рублей две копейки"
                              7.3 "Семь рублей три копейки"
                              7.4 "Семь рублей четыре копейки"
                              7.5 "Семь рублей пять копеек"
                              7.6 "Семь рублей шесть копеек"
                              7.7 "Семь рублей семь копеек"
                              7.8 "Семь рублей восемь копеек"
                              7.9 "Семь рублей девять копеек"
